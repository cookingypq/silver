...
const BitButton = ({
  ...
  return (
    <button
      {...rest}
      className={`bit-btn rounded-none active:translate-y-1 transition-transform relative inline-flex items-center justify-center gap-1.5 ${font === "retro" ? "retro" : ""} ${className}`}
    >
      {children}
      {/* Pixelated border */}
